...
if ($requested_location == 'Eastside') {
	$myemail  = 'elpaso-east@picassosmiles.com';
} else {
	$myemail  = 'elpaso-west@picassosmiles.com';
}
...
header('Location: /el-paso/about/thankyou.html');
exit();
